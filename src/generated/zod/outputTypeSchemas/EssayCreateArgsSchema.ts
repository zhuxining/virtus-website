...
export const EssayCreateArgsSchema: z.ZodType<Prisma.EssayCreateArgs> = z
	.object({
		select: EssaySelectSchema.optional(),
		include: z.lazy(() => EssayIncludeSchema).optional(),
		data: z.union([EssayCreateInputSchema, EssayUncheckedCreateInputSchema]),
	})
	.strict()

export default EssayCreateArgsSchema
