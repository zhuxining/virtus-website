...
export const EssayStatisticsFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.EssayStatisticsFindUniqueOrThrowArgs> =
	z
		.object({
...
export default EssayStatisticsFindUniqueOrThrowArgsSchema
