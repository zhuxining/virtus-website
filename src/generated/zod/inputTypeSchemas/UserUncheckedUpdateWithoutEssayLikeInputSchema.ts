...
export const UserUncheckedUpdateWithoutEssayLikeInputSchema: z.ZodType<Prisma.UserUncheckedUpdateWithoutEssayLikeInput> =
	z
		.object({
			id: z
				.union([
...
export default UserUncheckedUpdateWithoutEssayLikeInputSchema
