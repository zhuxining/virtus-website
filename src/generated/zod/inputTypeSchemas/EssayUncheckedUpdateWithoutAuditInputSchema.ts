...
export const EssayUncheckedUpdateWithoutAuditInputSchema: z.ZodType<Prisma.EssayUncheckedUpdateWithoutAuditInput> =
	z
		.object({
			id: z
				.union([
...
export default EssayUncheckedUpdateWithoutAuditInputSchema
