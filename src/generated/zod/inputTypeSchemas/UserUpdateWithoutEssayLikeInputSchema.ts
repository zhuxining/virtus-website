...
export const UserUpdateWithoutEssayLikeInputSchema: z.ZodType<Prisma.UserUpdateWithoutEssayLikeInput> =
	z
		.object({
			id: z
				.union([
...
export default UserUpdateWithoutEssayLikeInputSchema
