...
export const DonorInfoCreateNestedManyWithoutOperatorInputSchema: z.ZodType<Prisma.DonorInfoCreateNestedManyWithoutOperatorInput> =
	z
		.object({
			create: z
				.union([
...
export default DonorInfoCreateNestedManyWithoutOperatorInputSchema
