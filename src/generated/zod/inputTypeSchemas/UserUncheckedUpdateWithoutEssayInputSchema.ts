...
export const UserUncheckedUpdateWithoutEssayInputSchema: z.ZodType<Prisma.UserUncheckedUpdateWithoutEssayInput> =
	z
		.object({
			id: z
				.union([
...
export default UserUncheckedUpdateWithoutEssayInputSchema
