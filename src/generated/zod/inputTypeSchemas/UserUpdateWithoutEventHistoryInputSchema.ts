...
export const UserUpdateWithoutEventHistoryInputSchema: z.ZodType<Prisma.UserUpdateWithoutEventHistoryInput> =
	z
		.object({
			id: z
				.union([
...
export default UserUpdateWithoutEventHistoryInputSchema
