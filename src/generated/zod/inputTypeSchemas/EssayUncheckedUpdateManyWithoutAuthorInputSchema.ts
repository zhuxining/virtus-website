...
export const EssayUncheckedUpdateManyWithoutAuthorInputSchema: z.ZodType<Prisma.EssayUncheckedUpdateManyWithoutAuthorInput> =
	z
		.object({
			id: z
				.union([
...
export default EssayUncheckedUpdateManyWithoutAuthorInputSchema
