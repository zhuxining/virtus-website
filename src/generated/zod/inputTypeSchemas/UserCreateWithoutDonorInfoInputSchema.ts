...
export const UserCreateWithoutDonorInfoInputSchema: z.ZodType<Prisma.UserCreateWithoutDonorInfoInput> =
	z
		.object({
			id: z.string(),
			name: z.string(),
...
export default UserCreateWithoutDonorInfoInputSchema
