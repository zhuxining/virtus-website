...
export const EssayLikeUpdateManyWithoutOperatorNestedInputSchema: z.ZodType<Prisma.EssayLikeUpdateManyWithoutOperatorNestedInput> =
	z
		.object({
			create: z
				.union([
...
export default EssayLikeUpdateManyWithoutOperatorNestedInputSchema
