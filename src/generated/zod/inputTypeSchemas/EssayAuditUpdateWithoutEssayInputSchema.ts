...
export const EssayAuditUpdateWithoutEssayInputSchema: z.ZodType<Prisma.EssayAuditUpdateWithoutEssayInput> =
	z
		.object({
			auditStatus: z
				.union([
...
export default EssayAuditUpdateWithoutEssayInputSchema
