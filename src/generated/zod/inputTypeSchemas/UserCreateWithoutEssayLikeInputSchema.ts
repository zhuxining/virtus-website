...
export const UserCreateWithoutEssayLikeInputSchema: z.ZodType<Prisma.UserCreateWithoutEssayLikeInput> =
	z
		.object({
			id: z.string(),
			name: z.string(),
...
export default UserCreateWithoutEssayLikeInputSchema
