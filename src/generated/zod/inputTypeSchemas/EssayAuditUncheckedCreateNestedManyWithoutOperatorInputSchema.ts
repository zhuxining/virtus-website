...
export const EssayAuditUncheckedCreateNestedManyWithoutOperatorInputSchema: z.ZodType<Prisma.EssayAuditUncheckedCreateNestedManyWithoutOperatorInput> =
	z
		.object({
			create: z
				.union([
...
export default EssayAuditUncheckedCreateNestedManyWithoutOperatorInputSchema
