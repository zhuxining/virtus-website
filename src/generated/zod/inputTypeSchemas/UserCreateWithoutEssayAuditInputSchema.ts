...
export const UserCreateWithoutEssayAuditInputSchema: z.ZodType<Prisma.UserCreateWithoutEssayAuditInput> =
	z
		.object({
			id: z.string(),
			name: z.string(),
...
export default UserCreateWithoutEssayAuditInputSchema
