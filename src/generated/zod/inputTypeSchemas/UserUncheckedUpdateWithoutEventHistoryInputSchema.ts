...
export const UserUncheckedUpdateWithoutEventHistoryInputSchema: z.ZodType<Prisma.UserUncheckedUpdateWithoutEventHistoryInput> =
	z
		.object({
			id: z
				.union([
...
export default UserUncheckedUpdateWithoutEventHistoryInputSchema
