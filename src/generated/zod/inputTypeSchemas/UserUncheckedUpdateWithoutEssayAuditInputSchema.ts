...
export const UserUncheckedUpdateWithoutEssayAuditInputSchema: z.ZodType<Prisma.UserUncheckedUpdateWithoutEssayAuditInput> =
	z
		.object({
			id: z
				.union([
...
export default UserUncheckedUpdateWithoutEssayAuditInputSchema
