...
export const EssayAuditUncheckedUpdateManyWithoutEssayInputSchema: z.ZodType<Prisma.EssayAuditUncheckedUpdateManyWithoutEssayInput> =
	z
		.object({
			id: z
				.union([
...
export default EssayAuditUncheckedUpdateManyWithoutEssayInputSchema
