...
export const UserUpdateWithoutDonorInfoInputSchema: z.ZodType<Prisma.UserUpdateWithoutDonorInfoInput> =
	z
		.object({
			id: z
				.union([
...
export default UserUpdateWithoutDonorInfoInputSchema
