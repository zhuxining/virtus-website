...
export const EssayAuditUpdateManyWithoutOperatorNestedInputSchema: z.ZodType<Prisma.EssayAuditUpdateManyWithoutOperatorNestedInput> =
	z
		.object({
			create: z
				.union([
...
export default EssayAuditUpdateManyWithoutOperatorNestedInputSchema
