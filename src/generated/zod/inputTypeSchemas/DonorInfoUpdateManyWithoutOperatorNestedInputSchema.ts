...
export const DonorInfoUpdateManyWithoutOperatorNestedInputSchema: z.ZodType<Prisma.DonorInfoUpdateManyWithoutOperatorNestedInput> =
	z
		.object({
			create: z
				.union([
...
export default DonorInfoUpdateManyWithoutOperatorNestedInputSchema
