...
export const EssayLikeCreateNestedManyWithoutOperatorInputSchema: z.ZodType<Prisma.EssayLikeCreateNestedManyWithoutOperatorInput> =
	z
		.object({
			create: z
				.union([
...
export default EssayLikeCreateNestedManyWithoutOperatorInputSchema
