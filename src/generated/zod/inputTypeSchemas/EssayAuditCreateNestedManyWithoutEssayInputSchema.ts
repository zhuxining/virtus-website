...
export const EssayAuditCreateNestedManyWithoutEssayInputSchema: z.ZodType<Prisma.EssayAuditCreateNestedManyWithoutEssayInput> =
	z
		.object({
			create: z
				.union([
...
export default EssayAuditCreateNestedManyWithoutEssayInputSchema
