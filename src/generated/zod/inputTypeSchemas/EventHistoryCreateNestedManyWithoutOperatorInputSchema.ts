...
export const EventHistoryCreateNestedManyWithoutOperatorInputSchema: z.ZodType<Prisma.EventHistoryCreateNestedManyWithoutOperatorInput> =
	z
		.object({
			create: z
				.union([
...
export default EventHistoryCreateNestedManyWithoutOperatorInputSchema
