...
export const EssayUncheckedUpdateManyWithoutAuthorNestedInputSchema: z.ZodType<Prisma.EssayUncheckedUpdateManyWithoutAuthorNestedInput> =
	z
		.object({
			create: z
				.union([
...
export default EssayUncheckedUpdateManyWithoutAuthorNestedInputSchema
