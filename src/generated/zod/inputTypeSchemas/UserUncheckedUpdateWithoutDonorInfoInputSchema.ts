...
export const UserUncheckedUpdateWithoutDonorInfoInputSchema: z.ZodType<Prisma.UserUncheckedUpdateWithoutDonorInfoInput> =
	z
		.object({
			id: z
				.union([
...
export default UserUncheckedUpdateWithoutDonorInfoInputSchema
