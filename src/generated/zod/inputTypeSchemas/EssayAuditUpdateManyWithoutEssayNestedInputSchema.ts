...
export const EssayAuditUpdateManyWithoutEssayNestedInputSchema: z.ZodType<Prisma.EssayAuditUpdateManyWithoutEssayNestedInput> =
	z
		.object({
			create: z
				.union([
...
export default EssayAuditUpdateManyWithoutEssayNestedInputSchema
