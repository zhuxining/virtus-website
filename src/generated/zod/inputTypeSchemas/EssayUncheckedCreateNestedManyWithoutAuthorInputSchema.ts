...
export const EssayUncheckedCreateNestedManyWithoutAuthorInputSchema: z.ZodType<Prisma.EssayUncheckedCreateNestedManyWithoutAuthorInput> =
	z
		.object({
			create: z
				.union([
...
export default EssayUncheckedCreateNestedManyWithoutAuthorInputSchema
