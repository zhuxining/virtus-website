...
export const EssayAuditUncheckedUpdateManyInputSchema: z.ZodType<Prisma.EssayAuditUncheckedUpdateManyInput> =
	z
		.object({
			id: z
				.union([
...
export default EssayAuditUncheckedUpdateManyInputSchema
