...
export const EssayAuditUncheckedUpdateWithoutEssayInputSchema: z.ZodType<Prisma.EssayAuditUncheckedUpdateWithoutEssayInput> =
	z
		.object({
			id: z
				.union([
...
export default EssayAuditUncheckedUpdateWithoutEssayInputSchema
