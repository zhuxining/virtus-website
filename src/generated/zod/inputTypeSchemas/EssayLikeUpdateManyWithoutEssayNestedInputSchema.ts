...
export const EssayLikeUpdateManyWithoutEssayNestedInputSchema: z.ZodType<Prisma.EssayLikeUpdateManyWithoutEssayNestedInput> =
	z
		.object({
			create: z
				.union([
...
export default EssayLikeUpdateManyWithoutEssayNestedInputSchema
